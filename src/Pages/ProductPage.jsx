...
const ProductPage = () => {
  ...
  return (
    ...
    {isInterested ? 
    <>
    {isInterested == 'yes' ? <InterestedPage /> : <NeedMoreInfo />}
    </>
    :
    <>
...
<div className='pt-8 '>
<button onClick={()=>{setIsInterested('yes')}} className='font-medium text-white text-sm p-4 rounded bg-[#0E4B72]'>I'm Interested</button>
<span onClick={()=>{setIsInterested('no')}} className='font-medium text-sm p-4 rounded text-[#0E4B72]'>Need More Info?</span>
</div>
