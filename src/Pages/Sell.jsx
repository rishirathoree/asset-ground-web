  ...
  return (
    ...
    <div className='flex items-center justify-center flex-col px-8 lg:py-32 md:py-32 sm:py-20 lg:w-full md:w-full sm:w-full rounded-lg space-y-8'>
        <div className='bg-white shadow-custom py-6 px-12 lg:w-2/3 md:w-2/3 sm:w-full rounded-lg'>
            <p className='font-normal text-lg'>{steps === 0 ? 'Select Your Business Type' : steps === 1 ? 'About Business' :  steps === 2 ? 'Audience & Profitability' : 'Contact Information'}</p>
            <div className='mt-4'>
            {/* <form> */}
            <div className='space-y-6'>
                {steps == 0 && <div>
                    <p className='text-xsm font-medium text-gray-400'>Business Type?</p>
                    <select type="text" className="text-sm font-light text-gray-400 focus:outline-none outline-none ring-1 ring-black/5 focus:ring-black/20 duration-500 p-4 w-full rounded text-xsm "><option value="">Youtube Channel</option><option value="">Website</option><option value="">Domain Name</option></select>
                </div>}
            ...
            <div className='flex flex-col gap-2'>
                    ...
                    <input type="text" className="focus:outline-none outline-none ring-1 ring-black/5 focus:ring-black/20 duration-500 p-3 w-full rounded text-xsm " />
            </div>
            ...
            <div className='flex flex-col gap-2'>
                    ...
                    <select type="text" className="text-sm font-light text-gray-400 focus:outline-none outline-none ring-1 ring-black/5 focus:ring-black/20 duration-500 p-3 w-full rounded text-xsm "><option value="">Select Niche</option></select>
            </div>
            ...
            <div className='flex flex-col gap-2 relative'>
                    ...
                    <input id='dateInput' type="text" placeholder='MM/YYYY' className=" focus:outline-none outline-none ring-1 ring-black/5 focus:ring-black/20 duration-500 p-3 w-full rounded text-xsm " />
            ...
            <div className='flex flex-col gap-2'>
                    ...
                    <input id='dateInput' type="text" placeholder='Text Here...' className=" focus:outline-none outline-none ring-1 ring-black/5 focus:ring-black/20 duration-500 p-3 w-full rounded text-xsm " />
            ...
            <div className='flex flex-col gap-2'>
                    ...
                    <textarea id='dateInput' type="text" placeholder='Text Here...' className="h-40 appearance-none resize-none focus:outline-none outline-none ring-1 ring-black/5 focus:ring-black/20 duration-500 p-3 w-full rounded text-xsm " />
            </div>
            </>
            }
            ...
            <div>
                ...
                <input type="checkbox"/>
                <label className='font-light text-xsm text-gray-400' htmlFor="Channel URl">Yes</label>
                </div>

                <div className='flex gap-2 items-center'>
                <input type="checkbox"/>
                <label className='font-light text-xsm text-gray-400' htmlFor="Channel URl">No</label>
                </div>  
                </span>
            </div>
            ...
            <div className='flex flex-col gap-2 relative'>
                ...
                <div className='flex flex-col gap-2 w-full'>
                    ...
                    <input id='dateInput' type="text" placeholder='00' className=" focus:outline-none outline-none ring-1 ring-black/5 focus:ring-black/20 duration-500 p-3 w-full rounded text-xsm " />
            </div>
            <div className='flex flex-col gap-2 w-full'>
            ...
            <div className='flex flex-col gap-2 w-full'>
                    ...
                    <input id='dateInput' type="text" placeholder='Enter First Name' className=" focus:outline-none outline-none ring-1 ring-black/5 focus:ring-black/20 duration-500 p-3 w-full rounded text-xsm " />
            </div>
            <div className='flex flex-col gap-2 w-full'>
                    <label className='font-light text-xsm text-gray-400' htmlFor="Channel URl">Last Name</label>
                    <input id='dateInput' type="text" placeholder='Enter Last Name' className=" focus:outline-none outline-none ring-1 ring-black/5 focus:ring-black/20 duration-500 p-3 w-full rounded text-xsm " />
            </div>
            </span>

            <div className='flex flex-col gap-2 w-full'>
                    <label className='font-light text-xsm text-gray-400' htmlFor="Channel URl">Enter Email</label>
                    <input id='dateInput' type="email" placeholder='Enter Email' className=" focus:outline-none outline-none ring-1 ring-black/5 focus:ring-black/20 duration-500 p-3 w-full rounded text-xsm " />
            </div>

            <div>
            <p className='font-light text-xsm text-gray-400'>Phone Number</p>
            <div className='flex items-center'>
                <select className='focus:outline-none outline-none ring-1 ring-black/5 focus:ring-black/20 duration-500 p-3 w-20 rounded-l text-[14px]'><option>+91</option></select>
                <input id='dateInput' type="email" placeholder='Enter Phone Number' className="text-[12px] focus:outline-none outline-none ring-1 ring-black/5 focus:ring-black/20 duration-500 p-3 w-full rounded-r" />
            </div>
            </div>

            <div className='flex flex-col gap-2 w-full'>
                    <label className='font-light text-xsm text-gray-400' htmlFor="Channel URl">Message to us?</label>
                    <textarea id='dateInput' type="email" placeholder='Text Here..' className="resize-none appearance-none h-40 focus:outline-none outline-none ring-1 ring-black/5 focus:ring-black/20 duration-500 p-3 w-full rounded text-xsm " />
            </div>
            </>
            }

            <div className='gap-4 flex items-center'>             
            <button onClick={()=>{setSteps(p=> p - 1)}} className='cursor-pointer font-medium text-sm px-6 py-3 rounded text-[#0E4B72] ring-1 ring-black/5'>Back</button>
            <button onClick={()=>{setSteps(p=> p +1)}} className='font-medium text-white text-sm px-6 py-3 rounded bg-[#0E4B72]'>Next</button>
            </div>
